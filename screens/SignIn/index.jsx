                    ...
                    <View style={styles.btncontainer}>
                        ...
                        <TouchableOpacity onPress={() => { }}>
                            <View style={styles.button2}>
                                ...
                                <Text onPress={() => {
                                    Linking.canOpenURL("https://www.facebook.com/login/").then((supported) => {
                                        if (supported) {
                                            Linking.openURL("https://www.facebook.com/login/")
                                        }
                                        else {
                                            Alert.alert("Error with connecting facebook login page");
                                        }
                                    }).catch((error) => {
                                        Alert.alert("Error with connecting facebook login page");
                                    })
                                }} style={styles.btntext}>Connect with facebook</Text>
                            </View>
                        </TouchableOpacity>
